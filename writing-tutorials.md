# Writing Tutorials
Thank you for contributing to the Play with Kubernetes Classroom! This document shows you how to write a tutorial for the [Play with Kubernetes](http://training.play-with-docker.com/) training site. For more information about Play with Kubernetes, check out our [about page](./about.md).
